...
public final class StartingArmor {
    public static final Armor CLOTH_ARMOR = new Armor("Cloth Armor", List.of(HeroClass.WIZARD, HeroClass.ROGUE, HeroClass.HEALER), 5, 10, 4, 90);
    public static final Armor LEATHER_ARMOR = new Armor("Leather Armor", List.of(HeroClass.ARCHER, HeroClass.ROGUE, HeroClass.WARRIOR), 8, 20, 10, 70);
